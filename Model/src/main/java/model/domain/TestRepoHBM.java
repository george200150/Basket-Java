    ...
    void selectBilet(){
        try(Session session = sessionFactory.openSession()){
            ...
            try{
                ...
                List<Bilet> bilete = session.createQuery("from Bilete as b order by b.numeClient asc", Bilet.class)
    ...
    public static void main(String[] args) {
        try{
            ...
            try(Session session = sessionFactory.openSession()){
                ...
                session.save(new Bilet("","",1,"",""));
                session.save(new Bilet("","",2,"",""));
