package basket.model.domain;

import java.io.Serializable;
import java.util.Date;

public class Meci extends Entity<String> implements Comparable<Meci>, Serializable {
    private String home;
    private String away;
    private Date date;
    private TipMeci tip;
    ...
    @Override
    public int compareTo(Meci meci) {
        return this.getId().compareTo(meci.getId());
    }
}
